        ...
        <div className="two">
          ...
          <div>
            ...
            <div style={{ marginTop: "24px", display: "flex", gap: "10px", flexWrap: "wrap" }}>
              <button className="btn gold" onClick={onOpenFileModal} type="button" style={{ flex: "1 1 auto" }}>
          ...
          <div style={{ display: "grid", gap: "16px" }}>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: "22px", margin: "0 0 12px" }}>
                ₹ {courtCost.toLocaleString("en-IN")} <small style={{ fontSize: "11px", color: "var(--slate)", fontWeight: "normal" }}>illustrative estimate*</small>
              </h3>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: "22px", margin: "0 0 12px", color: "#fff" }}>
                ₹ {odrCost.toLocaleString("en-IN")} <small style={{ fontSize: "11px", color: "var(--gold-soft)", fontWeight: "normal" }}>statutory capped scale</small>
              </h3>
              <div style={{ fontSize: "13px", color: "#AEC0D6", display: "grid", gap: "8px" }}>
                ...
                <div>💰 <strong>Estimated Model Savings:</strong> <span style={{ color: "var(--gold)", fontWeight: 600 }}>₹ {savings.toLocaleString("en-IN")} (Illustrative Model)*</span></div>
              </div>
            </div>
          </div>
        </div>
